...
<h2><a href="{makeUrl url='my-account/'}">{getText id='My account'}</a> &raquo; <a href="{makeUrl url='my-account/send-invitation.html'}">{getText id='Send invitation'}</a></h2>
{include file='inc/main.tpl'}
<h3>{getText id='Users you have created'}</h3>
<form action="{makeUrl url='my-account/send-invitation.html'}" class="jNice" method="post">
    <fieldset>
