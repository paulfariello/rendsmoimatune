...
<div ui-view="">
	<div class="row" ng-if="account.users.length > 0">
		<div class="small-12 columns">
			<h3 ng-if="account.balance.length > 0"><i class="fa fa-balance-scale fa-lg fa-fw"></i>Balance</h3>
			<h3 ng-if="account.balance.length == 0"><i class="fa fa-users fa-lg fa-fw"></i>Utilisateurs</h3>
			<div class="balance">
	...
	<div class="row" ng-if="account.users.length > 1">
		<div class="small-12 columns">
