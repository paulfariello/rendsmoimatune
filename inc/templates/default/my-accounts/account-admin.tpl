...
<h2><a href="{makeUrl url='my-accounts/'}">{getText id='My accounts'}</a> &raquo; <a href="#">Séjour a gauche</a> &raquo; <a href="#" class="active">{getText id='Admin'}</a></h2>
{include file='inc/main.tpl'}

                	<form action="" class="jNice">
					<h3>{getText id='Users'}</h3>
